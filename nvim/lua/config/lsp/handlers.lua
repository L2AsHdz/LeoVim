...
local function lsp_keymaps(bufnr)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>cw", "<cmd>Trouble workspace_diagnostics<CR>", opts)
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>cD", "<cmd>Trouble document_diagnostics<CR>", opts)
